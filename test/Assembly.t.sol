...
contract TestAssembly is Test {
  ...
  function testFuzz_sumSolidity(uint256[] memory data) public view{
    ass.sumSolidity(data);
  }
  function testFuzz_sumHalfAssembly(uint256[] memory data) public view{
    ass.sumHalfAssembly(data);
  }
  function testFuzz_sumAssembly(uint256[] memory data) public view{
